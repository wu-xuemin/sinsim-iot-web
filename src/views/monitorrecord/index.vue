  ...
  <div class="app-container">
    ...
    <el-table :data="tableData" style="width: 100%">
      ...
      <el-table-column prop="sceneId" label="抓拍照" align="center">
        <template slot-scope="{ row }">
          <img :src="feachSceneImage(row.sceneId)" width="60" height="60" @click="big(row)" />
        </template>
      </el-table-column>
      ...
      <el-table-column prop="location" label="通道名称" align="center">
        <template slot-scope="{ row }">
...
export default {
  ...
  methods: {
    handleDownload() {
      candidExport(this.account, this.listQuery)
        .then(res => {
          if (res.code == 400) {
    ...
    getVisitRecordList() {
      ...
      return fetchTaskRecord(this.listQuery)
        .then(res => {
