...
//员工新增
export function addStaff(account, data) {
  return request({
    url: `/staff/info/add`,
    method: 'post',
    data
...
//员工修改
export function updateStaff(account, data) {
  return request({
    url: `/staff/info/update`,
    method: 'put',
    data
  })
}
...
//员工删除
export function deleteStaff(account, id) {
  return request({
    url: `/staff/info/delete/${id}`,
    method: 'delete'
  })
}

//员工离职
export function resignStaff(staffId) {
  return request({
    url: `/staff/info/setting/${staffId}`,
    method: 'post'
  })
}
